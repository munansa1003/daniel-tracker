...
| 18 | **Vercel 프리뷰 관행 → 프리뷰 채널** | `api/_lib/security.js:17` `VERCEL_URL` · `docs/DEPLOY-PATH-B.md §1.5` | 채널 URL은 매번 다른 호스트 → 로그인·App Check·checkOrigin 모두 별도 정책 필요 | 개발 흐름 | 03 §2 3안 비교 | 후 | P2 |
